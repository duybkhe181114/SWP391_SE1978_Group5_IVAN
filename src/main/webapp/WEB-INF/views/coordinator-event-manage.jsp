            ...
            <div style="background: white; padding: 25px; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.03);">
                ...
                <form method="post" action="${pageContext.request.contextPath}/coordinator/assign-task">
                    ...
                    <div style="margin-bottom: 15px;">
                        <label style="display: block; font-size: 13px; font-weight: 600; color: #475569; margin-bottom: 8px;">Assign To <span style="color: red;">*</span></label>
                    ...
                    <div style="margin-bottom: 15px;">
                        <label style="display: block; font-size: 13px; font-weight: 600; color: #475569; margin-bottom: 8px;">Task Description <span style="color: red;">*</span></label>
                        <textarea name="taskDescription" required rows="3" placeholder="What needs to be done?" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 8px; resize: vertical;"></textarea>
                    </div>

                    <div style="background: #f8fafc; padding: 15px; border-radius: 8px; margin-bottom: 20px; border: 1px solid #e2e8f0;">
                        <h4 style="margin: 0 0 10px 0; font-size: 13px; color: #334155;">🗓️ Schedule (Required)</h4>

                        <div style="margin-bottom: 10px;">
                            <label style="font-size: 12px; color: #64748b;">Date:</label>
                            <input type="date" name="workDate" required style="width: 100%; padding: 8px; border: 1px solid #cbd5e1; border-radius: 6px;">
                        </div>
                    ...
                    <button type="submit" class="btn-primary" style="width: 100%; padding: 12px; border-radius: 8px; background: #8b5cf6; border-color: #8b5cf6; font-weight: 700;">
                        🚀 Assign Task
                    </button>
                </form>
            </div>
                                    ...
                                    <c:forEach items="${eventTasks}" var="t">
                                        <div style="padding: 15px; border: 1px solid #e2e8f0; border-radius: 12px; background: #f8fafc;">
                                            <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                                <span style="font-weight: 700; color: #1e293b; font-size: 15px;">${t.volunteerName}</span>
                                                ...
                                                <span style="font-size: 12px; font-weight: 700; padding: 4px 10px; border-radius: 20px;
                                                      ${t.status == 'Pending' ? 'background:#fef9c3; color:#854d0e;' :
                                                        ...
                                                        t.status == 'Completed' ? 'background:#dcfce7; color:#166534;' : 'background:#e2e8f0; color:#475569;'}">
                                                    ${t.status}
                                                </span>
                                            </div>

                                            <p style="color: #475569; font-size: 14px; margin: 0 0 10px 0;">${t.description}</p>
