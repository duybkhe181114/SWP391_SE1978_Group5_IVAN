...
<body>
    <div class="register-container">
        ...
        <form method="post" action="${pageContext.request.contextPath}/register/volunteer">
            ...
            <div class="form-group">
                <label>Email *</label>
                <input type="email" name="email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="example@email.com">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" value="Volunteer" readonly style="background: #f0f9ff; color: #0369a1; font-weight: 600;">
            </div>
